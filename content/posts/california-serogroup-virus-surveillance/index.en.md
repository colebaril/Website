...
categories:
- research
date: "2022-08-10T21:29:01+08:00"
description: California Serogroup Virus Surveillance 
draft: false
images: []
...
In 2020, 30 pools of mosquito RNA representing 17,423 mosquitoes were screened for the presence of a California serogroup virus by PCR using the BCS82CF/BCS332VR primer pair as described by Kuno et al., (1996). Due to time, personnel, and resource constraints, only a subset of identified mosquitoes spread out across time and locations was screened for CSGVs. Species screened were chosen based on virus detections made by Anderson et al., (2015). One pool (pool 1.3) tested positive for a California serogroup virus (Figure 2 15). One positive sample was identified among the samples that made up pool 1.3 (409.3; Figure 2 15). 409.3 made up a pool of 28 Aedes vexans mosquitoes caught on August 2nd, 2020, in Brandon, Manitoba. Viral species could not be determined. We did not detect any CSGVs in RNA sequencing samples, possibly due to extremely low abundance of RNA within the sample. 

In 2021, 68 pools of mosquitoes representing 16,759 mosquitoes were screened for the presence of a California serogroup virus by PCR. One pool of Ae. vexans caught in Shoal Lake, Manitoba during CDC week 30 tested positive for the presence of a California serogroup virus (Figure 2 16). Through Sanger sequencing, viral species was identified as Cache Valley Virus. We did not detect any CSGVs in RNA sequencing samples, possibly due to extremely low abundance of RNA within the sample. 
